...
SELECT *
FROM world_life_expectancy_raw;
...
DELETE FROM world_life_expectancy_raw
WHERE Row_ID IN (
        SELECT Row_ID
        FROM (
                SELECT Row_ID,
...
UPDATE world_life_expectancy_raw t1
    JOIN world_life_expectancy_raw t2 
...
FROM world_life_expectancy_raw t1
JOIN world_life_expectancy_raw t2
    ON t1.Country = t2.Country
    AND t1.Year = t2.Year - 1
JOIN world_life_expectancy_raw t3
...
FROM world_life_expectancy_raw AS wle 
...
UPDATE world_life_expectancy_raw
